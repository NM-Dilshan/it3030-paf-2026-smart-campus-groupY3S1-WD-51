...
public class AdminResourceSeeder implements CommandLineRunner {
    ...
    private static final Logger log = LoggerFactory.getLogger(AdminResourceSeeder.class);
    ...
    public void run(String... args) {
        try {
            ...
            log.warn("Skipping admin resource seeding because MongoDB is not available: {}", ex.getMessage());
        }
    }
}